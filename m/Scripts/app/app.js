...
$('[data-role=page]').on('pageshow', function (event, ui) {
    $("#" + event.target.id).find("[data-role=footer]").html("<span aria-level='1' role='heading' class='ui-title'>© 2015 Dipen Shah. All Rights Reserved.</span><center><a href='http://dipen08it419.github.io/index.html?rbm=false'>visit full site</a></center>");
});
